...
const STORAGE_KEY = "lare-quiz-progress-v4";
    ...
    try {
      const response = await fetch("/api/library-quiz", {
        ...
        body: JSON.stringify({
          ...
          promptStyle: "Prioritize exam-relevant questions. Include a mix of single-answer and select-all-that-apply questions when appropriate.",
        }),
      });
                ...
                {missedQuestions.map((item, index) => (
                  ...
                  >
                    ...
                    <p style={styles.reviewLine}>
                      ...
                      {item.selectedAnswer.length ? item.selectedAnswer.join(", ") : "No answer"}
                    </p>
